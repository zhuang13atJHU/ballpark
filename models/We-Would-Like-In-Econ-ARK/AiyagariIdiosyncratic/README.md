...
5. The following graph contains main files and shows how this folder is structured.
   ...
   ```mermaid
   graph TD;
      Current-->Aiyagari1994QJE
      Current-->Aiyagari.yaml
      Current-->Code
      Current-->Tex
      Current-->do_all.py
      Current-->README.md
      Current--> Table_SaingRate.md
   ...
   * "Tex" is a folder where the .tex file is located. It includes main content, figures, tables, and an appendix as a subfile. 
